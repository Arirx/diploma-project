      ...
      <div className="container">
        <div className="footer__grid">
          ...
          <div>
            ...
            <div className="footer__logo-sub">ООО «Ельсклес»</div>
            <p className="footer__desc">
              Надёжный поставщик пиломатериалов из Беларуси с&nbsp;2010&nbsp;года.
              Экспортируем в&nbsp;8&nbsp;стран мира.
            </p>
          ...
          {/* Products */}
          <div>
            <div className="footer__col-title">Продукция</div>
            <nav className="footer__links">
              {[
                ...
                <Link key={item} to="/products" className="footer__link">{item}</Link>
              ))}
            </nav>
          </div>
          ...
          <div>
            ...
            <div className="footer__contact-item">
              ...
              <span>г. Ельск, Кочищанский тракт 6/1, 247792, Беларусь</span>
            </div>
            <div className="footer__contact-item">
              <span className="footer__contact-icon">📞</span>
        ...
        <div className="footer__bottom">
          <p>© {year} ООО «Ельсклес». Все права защищены.</p>
          <p>УНП 490333750 · Гомельская область, Беларусь</p>
        </div>
      </div>
    </footer>
  );
