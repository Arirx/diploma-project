...
export const PRODUCTS = [
  ...
  },
  {
    ...
    desc: {
      ru: 'Высококалорийный уголь из сосны. Подходит для металлургии, ресторанов и домашних мангалов.',
      en: 'High-calorie charcoal from pine. Suitable for metallurgy, restaurants and BBQ.',
      by: 'Высококалярыйны вугаль з хваі. Падыходзіць для металургіі і барбекю.',
    },
    specs: {
      ru: [['Сырьё', 'Сосна'], ['Калорийность', '≥ 29 МДж/кг'], ['Влажность', 'до 8%'], ['Фасовка', '5, 10, 25 кг / насыпью']],
      en: [['Raw material', 'Pine'], ['Calorific value', '≥ 29 MJ/kg'], ['Moisture', 'up to 8%'], ['Packing', '5, 10, 25 kg / bulk']],
      by: [['Сыравіна', 'Хваёвая'], ['Калярыйнасць', '≥ 29 МДж/кг'], ['Вільготнасць', 'да 8%']],
    },
  },
  {
    id: 'wood-chips',
    ...
    specs: {
      ru: [['Порода', 'Сосна'], ['Фракция', '15–30 мм'], ['Влажность', '40–55%'], ['Поставка', 'Насыпью, самосвалами']],
      en: [['Species', 'Pine'], ['Fraction', '15–30 mm'], ['Moisture', '40–55%'], ['Supply', 'Bulk, dump trucks']],
      by: [['Парода', 'Хваёвая'], ['Фракцыя', '15–30 мм'], ['Вільготнасць', '40–55%']],
    },
  },
  {
    id: 'sawdust',
  ...
  },
  {
    ...
    group: 'byproduct',
    cat:   { ru: 'Отходы / сырьё', en: 'By-products', by: 'Адходы / сыравіна' },
    title: { ru: 'Обрезки', en: 'Offcuts', by: 'Абрэзкі' },
    desc: {
      ru: 'Обрезки от производства. Подходят для ограждений, тары, черновых строительных работ.',
      en: 'Production offcuts. Suitable for fencing, crating and rough construction.',
      by: 'Абрэзкі ад вытворчасці. Падыходзяць для агароджаў і тары.',
    },
    specs: {
