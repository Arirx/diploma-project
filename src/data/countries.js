...
export const COUNTRY_NAMES = {
  /* ── Арктика ─────────────────────────────────── */
  304: { ru: 'Гренландия',               en: 'Greenland',                  by: 'Грэнландыя'                  },
  /* ── CIS / Eastern Europe ─────────────────── */
  ...
  12:  { ru: 'Алжир',                    en: 'Algeria',                    by: 'Алжыр'                       },
  478: { ru: 'Мавритания',               en: 'Mauritania',                 by: 'Маўрытанія'                  },
  729: { ru: 'Судан',                    en: 'Sudan',                      by: 'Судан'                       },
  728: { ru: 'Южный Судан',              en: 'South Sudan',                by: 'Паўднёвы Судан'              },
  231: { ru: 'Эфиопия',                  en: 'Ethiopia',                   by: 'Эфіопія'                     },
  232: { ru: 'Эритрея',                  en: 'Eritrea',                    by: 'Эрытрэя'                     },
  706: { ru: 'Сомали',                   en: 'Somalia',                    by: 'Самалі'                      },
  404: { ru: 'Кения',                    en: 'Kenya',                      by: 'Кенія'                       },
  800: { ru: 'Уганда',                   en: 'Uganda',                     by: 'Уганда'                      },
  834: { ru: 'Танзания',                 en: 'Tanzania',                   by: 'Танзанія'                    },
  646: { ru: 'Руанда',                   en: 'Rwanda',                     by: 'Руанда'                      },
  108: { ru: 'Бурунди',                  en: 'Burundi',                    by: 'Бурундзі'                    },
  180: { ru: 'ДР Конго',                 en: 'DR Congo',                   by: 'ДР Конга'                    },
  178: { ru: 'Республика Конго',         en: 'Republic of Congo',          by: 'Рэспубліка Конга'            },
  140: { ru: 'ЦАР',                      en: 'Central African Republic',   by: 'ЦАР'                         },
  120: { ru: 'Камерун',                  en: 'Cameroon',                   by: 'Камерун'                     },
  266: { ru: 'Габон',                    en: 'Gabon',                      by: 'Габон'                       },
  226: { ru: 'Экваториальная Гвинея',    en: 'Equatorial Guinea',          by: 'Экватарыяльная Гвінея'       },
  566: { ru: 'Нигерия',                  en: 'Nigeria',                    by: 'Нігерыя'                     },
  204: { ru: 'Бенин',                    en: 'Benin',                      by: 'Бенін'                       },
  768: { ru: 'Того',                     en: 'Togo',                       by: 'Тога'                        },
  288: { ru: 'Гана',                     en: 'Ghana',                      by: 'Гана'                        },
  384: { ru: 'Кот-д\'Ивуар',             en: 'Ivory Coast',                by: 'Кот-д\'Івуар'                },
  430: { ru: 'Либерия',                  en: 'Liberia',                    by: 'Ліберыя'                     },
  694: { ru: 'Сьерра-Леоне',             en: 'Sierra Leone',               by: 'Сьера-Леонэ'                 },
  624: { ru: 'Гвинея-Бисау',              en: 'Guinea-Bissau',              by: 'Гвінея-Бісаў'                },
  324: { ru: 'Гвинея',                   en: 'Guinea',                     by: 'Гвінея'                      },
  270: { ru: 'Гамбия',                   en: 'Gambia',                     by: 'Гамбія'                      },
  262: { ru: 'Джибути',                  en: 'Djibouti',                   by: 'Джыбуці'                     },
  732: { ru: 'Западная Сахара',          en: 'Western Sahara',             by: 'Заходняя Сахара'             },
  466: { ru: 'Мали',                     en: 'Mali',                       by: 'Малі'                        },
  854: { ru: 'Буркина-Фасо',             en: 'Burkina Faso',               by: 'Буркіна-Фасо'                },
  562: { ru: 'Нигер',                    en: 'Niger',                      by: 'Нігер'                       },
  686: { ru: 'Сенегал',                  en: 'Senegal',                    by: 'Сенегал'                     },
  148: { ru: 'Чад',                      en: 'Chad',                       by: 'Чад'                         },
  24:  { ru: 'Ангола',                   en: 'Angola',                     by: 'Ангола'                      },
  894: { ru: 'Замбия',                   en: 'Zambia',                     by: 'Замбія'                      },
  454: { ru: 'Малави',                   en: 'Malawi',                     by: 'Малаві'                      },
  508: { ru: 'Мозамбик',                 en: 'Mozambique',                 by: 'Мазамбік'                    },
  716: { ru: 'Зимбабве',                 en: 'Zimbabwe',                   by: 'Зімбабвэ'                    },
  516: { ru: 'Намибия',                  en: 'Namibia',                    by: 'Намібія'                     },
  72:  { ru: 'Ботсвана',                 en: 'Botswana',                   by: 'Батсвана'                    },
  710: { ru: 'ЮАР',                      en: 'South Africa',               by: 'ПАР'                         },
  748: { ru: 'Эсватини',                 en: 'Eswatini',                   by: 'Эсваціні'                    },
  426: { ru: 'Лесото',                   en: 'Lesotho',                    by: 'Лесота'                      },
  450: { ru: 'Мадагаскар',               en: 'Madagascar',                 by: 'Мадагаскар'                  },
  /* ── Americas ────────────────────────────────── */
  840: { ru: 'США',                      en: 'United States',              by: 'ЗША'                         },
  124: { ru: 'Канада',                   en: 'Canada',                     by: 'Канада'                      },
  484: { ru: 'Мексика',                  en: 'Mexico',                     by: 'Мексіка'                     },
  320: { ru: 'Гватемала',                en: 'Guatemala',                  by: 'Гватэмала'                   },
  340: { ru: 'Гондурас',                 en: 'Honduras',                   by: 'Гандурас'                    },
  222: { ru: 'Сальвадор',                en: 'El Salvador',                by: 'Сальвадор'                   },
  558: { ru: 'Никарагуа',                en: 'Nicaragua',                  by: 'Нікарагуа'                   },
  188: { ru: 'Коста-Рика',               en: 'Costa Rica',                 by: 'Коста-Рыка'                  },
  84:  { ru: 'Белиз',                     en: 'Belize',                     by: 'Беліз'                       },
  591: { ru: 'Панама',                   en: 'Panama',                     by: 'Панама'                      },
  192: { ru: 'Куба',                     en: 'Cuba',                       by: 'Куба'                        },
  388: { ru: 'Ямайка',                   en: 'Jamaica',                    by: 'Ямайка'                      },
  780: { ru: 'Тринидад и Тобаго',        en: 'Trinidad and Tobago',        by: 'Трынідад і Табага'           },
  332: { ru: 'Гаити',                    en: 'Haiti',                      by: 'Гаіці'                       },
  214: { ru: 'Доминиканская Республика', en: 'Dominican Republic',         by: 'Дамініканская Рэспубліка'    },
  862: { ru: 'Венесуэла',                en: 'Venezuela',                  by: 'Венесуэла'                   },
  328: { ru: 'Гайана',                   en: 'Guyana',                     by: 'Гаяна'                       },
  740: { ru: 'Суринам',                  en: 'Suriname',                   by: 'Сурынам'                     },
  170: { ru: 'Колумбия',                 en: 'Colombia',                   by: 'Калумбія'                    },
  218: { ru: 'Эквадор',                  en: 'Ecuador',                    by: 'Эквадор'                     },
  604: { ru: 'Перу',                     en: 'Peru',                       by: 'Перу'                        },
  68:  { ru: 'Боливия',                  en: 'Bolivia',                    by: 'Балівія'                     },
  76:  { ru: 'Бразилия',                 en: 'Brazil',                     by: 'Бразілія'                    },
  600: { ru: 'Парагвай',                 en: 'Paraguay',                   by: 'Парагвай'                    },
  858: { ru: 'Уругвай',                  en: 'Uruguay',                    by: 'Уругвай'                     },
  152: { ru: 'Чили',                     en: 'Chile',                      by: 'Чылі'                        },
  32:  { ru: 'Аргентина',                en: 'Argentina',                  by: 'Аргенціна'                   },
  /* ── Europe (дополнение) ─────────────────────── */
  196: { ru: 'Кипр',                     en: 'Cyprus',                     by: 'Кіпр'                        },
  70:  { ru: 'Босния и Герцеговина',     en: 'Bosnia and Herzegovina',     by: 'Боснія і Герцагавіна'        },
  8:   { ru: 'Албания',                  en: 'Albania',                    by: 'Албанія'                     },
  807: { ru: 'Северная Македония',       en: 'North Macedonia',            by: 'Паўночная Македонія'         },
  499: { ru: 'Черногория',               en: 'Montenegro',                 by: 'Чарнагорыя'                  },
  705: { ru: 'Словения',                 en: 'Slovenia',                   by: 'Славенія'                    },
  /* ── Asia (дополнение) ───────────────────────── */
  4:   { ru: 'Афганистан',               en: 'Afghanistan',                by: 'Афганістан'                  },
  512: { ru: 'Оман',                     en: 'Oman',                       by: 'Аман'                        },
  64:  { ru: 'Бутан',                    en: 'Bhutan',                     by: 'Бутан'                       },
  626: { ru: 'Восточный Тимор',          en: 'Timor-Leste',                by: 'Усходні Тымор'               },
  /* ── Oceania ─────────────────────────────────── */
  36:  { ru: 'Австралия',                en: 'Australia',                  by: 'Аўстралія'                   },
  554: { ru: 'Новая Зеландия',           en: 'New Zealand',                by: 'Новая Зеландыя'              },
  598: { ru: 'Папуа — Новая Гвинея',     en: 'Papua New Guinea',           by: 'Папуа — Новая Гвінея'        },
};
